<?php
	...
	if(isset($_POST["submitcmt"])){
		...
		insert_comment($name2,$email2,$website2,$message2);
	}	
	
	$data = get_list_comment();
?>
<!DOCTYPE html>
<html lang="en">
  <head>
	            ...
	            <div class="pt-5 mt-5">
					...
					<?php
						foreach($data as $key => $values){ 
							...
							<li class="comment">
								...
								<h3 name = name_cmt><?=$values["name"]?></h3>
								<div class="meta">October 03, 2018 at 2:21pm</div>
								<p name = "message_cmt"><?=$values["message"]?></p>
	              ...
	              <div class="comment-form-wrap pt-5">
	                ...
	                <form action="" class="p-3 p-md-5 bg-light" method="post">
	                  ...
	                  <div class="form-group">
	                    <input type="submit" name="submitcmt" value="Post Comment" class="btn py-3 px-4 btn-primary">
	                  </div>
